function show_loader() {
	$("body").append(
		'<div class="popup-box"><div class="preloader pl-xxl"><svg viewBox="25 25 50 50" class="pl-circular"><circle r="20" cy="50" cx="50" class="plc-path"/></svg></div></div><span class="popup-bg"></span>'
	);
}
	...
	e.extend(e.validator, {
			...
			checkForm: function() {
				...
				for (
					...
					if (
						...
						for (
							var n = 0;
							n < this.findByName(t[e].name).length;
							n++
						) {
		...
		attributeRules: function(t) {
			...
			for (var s in e.validator.methods) {
				...
				if (
					/min|max/.test(s) &&
					(i === null || /number|range|text/.test(i))
				) {
					o = Number(o);
				}
				if (o) {
						...
						true,
						{
							...
							success: function(r) {
								...
								if (o) {
									...
									a[n.name] = i.message = e.isFunction(f)
										? f(t)
										: f;
